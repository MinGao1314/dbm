...
class DPP439_eigen_values:
    ...
    def initialisation(self):
        real_values = np.random.uniform(-0.005, 0.005, size=(self.n_traj, self.n_traj))
        im_values = np.random.uniform(-0.005, 0.005, size=(self.n_traj, self.n_traj))
...
if __name__ == '__main__':
    test = DPP439_eigen_values(15, 1000, 1)
